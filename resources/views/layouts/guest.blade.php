...
<body class="m-0 p-0 min-h-screen flex font-sans bg-gray-50 overflow-hidden">
  ...
  @if (request()->routeIs('password.request'))
    <!-- Layout especial para recuperación de contraseña -->
    <div class="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-sky-100 to-sky-300">
      {{ $slot }}
    </div>
  @else
